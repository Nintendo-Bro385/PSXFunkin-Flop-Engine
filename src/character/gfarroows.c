...
static const CharFrame char_gf_frame[] = {
	{GF_ArcMain_Hud41, {  0,   0,  74, 103}, { 37,  72}}, //0 bop left 1
	{GF_ArcMain_Hud42, { 75,   0,  74, 103}, { 38,  72}}, //1 bop left 2
	{GF_ArcMain_Hud43, {150,   0,  73, 102}, { 37,  72}}, //2 bop left 3
	{GF_ArcMain_Hud44, {  0, 104,  73, 103}, { 36,  73}}, //3 bop left 4
	
	{GF_ArcMain_Hud41, {  0,   0,  73, 100}, { 34,  71}}, //12 cry 1
	{GF_ArcMain_Hud42, { 74,   0,  73, 102}, { 35,  72}}, //13 cry 2
	{GF_ArcMain_Hud43, {148,   0,  73, 102}, { 34,  72}}, //14 cry 3
	{GF_ArcMain_Hud44, {  0, 101,  74, 102}, { 35,  72}}, //15 cry 4
	{GF_ArcMain_Hud41, { 75, 102,  73, 102}, { 34,  72}}, //16 cry 5
...
static const Animation char_gf_anim[CharAnim_Max] = {
	...
	{2, (const u8[]){9, 10, ASCR_BACK, 1}},                                 //CharAnim_Left
	{1, (const u8[]){ 0,  0,  0,  0,  1,  1,  1,  1, ASCR_BACK, 1}}, //CharAnim_LeftAlt
	{2, (const u8[]){19, 20, ASCR_BACK, 1}},                                 //CharAnim_Down
	{1, (const u8[]){4, 5, 6, 7, 8, ASCR_REPEAT}},                      //CharAnim_DownAlt
	...
	{1, (const u8[]){ 2,  2,  2,  2,  3,  3,  3,  3, ASCR_BACK, 1}}, //CharAnim_RightAlt
};
...
Character *Char_GF_New(fixed_t x, fixed_t y)
{
	...
	const char **pathp = (const char *[]){
		"hud41.tim", //GF_ArcMain_GF0
		"hud42.tim", //GF_ArcMain_GF1
		"hud43.tim", //GF_ArcMain_GF2
		"hud44.tim",
		NULL
	};
